...
# A Family Dentist Kissimmee — Dr. Mohammed Zaman, 11 W Dakin Ave Kissimmee FL 34741
# 30+ years experience, bilingual Spanish, same-day emergencies, M-Th 8:30-5, Fri 8:30-1
ZAMAN_SUBS = [
    ("Wayside Family Dental — After-Hours Concierge | Powered by Velo AI",
     "A Family Dentist Kissimmee — After-Hours Concierge | Powered by Velo AI"),
    ("This is a live demo built by Velo AI for Wayside Family Dental.",
     "This is a live demo built by Velo AI for A Family Dentist Kissimmee."),
    ("Sanford, Florida · Est. 2012", "Kissimmee, Florida · Over 30 Years of Care · Se Habla Español"),
    ('<h1 class="practice-name">Wayside Family Dental</h1>',
     '<h1 class="practice-name">A Family Dentist</h1>'),
    ('<p class="practice-doctor">Dr. Lyudmila A. Onyski, DDS</p>',
     '<p class="practice-doctor">Dr. Mohammed M. Zaman, DDS</p>'),
    ("Dr. Onyski is on call to respond to her patients' needs as soon as possible. As a patient of Wayside, you're never alone.",
     "Dr. Zaman has been caring for Kissimmee families for over 30 years. Same-day emergency appointments are available, and Spanish-speaking care is offered to every patient who needs it."),
    ("4907 International Pkwy, Suite 1041<br>Sanford, FL 32771",
     "11 W Dakin Ave<br>Kissimmee, FL 34741"),
    ("(407) 732-4570", "(407) 846-3662"),
    ("<strong>Wayside Concierge</strong> · Available 24/7",
     "<strong>A Family Dentist Concierge</strong> · Available 24/7"),
    ("A patient of Wayside? Dr. Onyski will be notified immediately for urgent matters.",
     "A patient of A Family Dentist? Dr. Zaman will be notified immediately for urgent matters."),
    ("Good evening — you've reached the after-hours line for Wayside Family Dental. Dr. Onyski is unavailable right now, but I can help with most things and reach her directly if it's urgent.",
     "Good evening — you've reached the after-hours line for A Family Dentist. Dr. Zaman is unavailable right now, but I can help with most things and reach him directly if it's urgent. Si prefiere español, también puedo ayudarle."),
    ("Let me get you to Dr. Onyski as quickly as possible.",
     "Let me get you to Dr. Zaman as quickly as possible."),
    ("Understood. I'm flagging this as urgent and texting Dr. Onyski now — she'll call you back within 15 minutes.",
     "Understood. I'm flagging this as urgent and texting Dr. Zaman now — he'll call you back within 15 minutes."),
    ("Got it. Dr. Onyski will want to see you first thing — she keeps emergency slots open every morning at 8 AM specifically for situations like this.",
     "Got it. Dr. Zaman keeps same-day emergency slots open specifically for situations like this."),
    ("Great choice to reach out — both implants and Invisalign are major decisions and Dr. Onyski has been doing both since 2010, so you're in capable hands.",
     "Great choice to reach out — Dr. Zaman has placed implants and restored smiles in Kissimmee for over 30 years. You'll get an honest answer on whether you're a candidate before anyone talks dollars."),
    ("Most patients asking about ${txt} have one of two questions on their mind: <em>\"Am I a candidate?\"</em> and <em>\"What will it actually cost?\"</em><br><br>Both are best answered with a 30-minute consult — Dr. Onyski does a digital scan, reviews your options, and gives you a treatment plan with real numbers before you commit to anything. Wayside also accepts CareCredit if financing helps.",
     "Most patients asking about ${txt} have one of two questions: <em>\"Am I a candidate?\"</em> and <em>\"What will it actually cost?\"</em><br><br>Dr. Zaman handles both in a single consult — exam, real options, and a treatment plan with actual numbers before you commit. The practice has worked with Kissimmee families across generations, so honest no-pressure conversations are the default. Financing options available."),
    ("Perfect. Let me hold ${timeMap[value]} for you. What's your first name so I can put it on Dr. Onyski's schedule?",
     "Perfect. Let me hold ${timeMap[value]} for you. What's your first name so I can put it on Dr. Zaman's schedule?"),
    ("Welcome — Dr. Onyski has been welcoming new patients to Wayside since 2012, and most of our patients come from referrals, so it's nice when someone finds us directly.",
     "Welcome — Dr. Zaman has been caring for Kissimmee families for over 30 years, and most patients come from referrals across multiple generations. It's nice when someone finds us directly."),
    ("Of course — go ahead and type your question and I'll do my best. If it's something Dr. Onyski needs to weigh in on personally, I'll route it to her and she'll get back to you in the morning.",
     "Of course — go ahead and type your question and I'll do my best. If it's something Dr. Zaman needs to weigh in on personally, I'll route it to him and he'll get back to you in the morning."),
    ("Thank you, ${memory.name}. What's the best phone number to reach you at? I want to make sure Dr. Onyski has it before tomorrow morning.",
     "Thank you, ${memory.name}. What's the best phone number to reach you at? I want to make sure Dr. Zaman has it before tomorrow morning."),
    ("Thanks, ${memory.name}. What's the best phone number? Dr. Onyski's office will text you a confirmation within an hour of opening.",
     "Thanks, ${memory.name}. What's the best phone number? Dr. Zaman's office will text you a confirmation within an hour of opening."),
    ("Thank you, ${memory.name}. What's the best callback number? Dr. Onyski will call you within 15 minutes.",
     "Thank you, ${memory.name}. What's the best callback number? Dr. Zaman will call you within 15 minutes."),
    ("Perfect. Here's the hold I'm creating for Dr. Onyski:",
     "Perfect. Here's the hold I'm creating for Dr. Zaman:"),
    ("Got it, ${memory.name} — I just paged Dr. Onyski. Expect a call from <strong>(407) 732-4570</strong> within 15 minutes.<br><br>Stay calm, sit upright if possible, and avoid hot or cold liquids until she calls. You're going to be okay.",
     "Got it, ${memory.name} — I just paged Dr. Zaman. Expect a call from <strong>(407) 846-3662</strong> within 15 minutes.<br><br>Stay calm, sit upright if possible, and avoid hot or cold liquids until he calls. You're going to be okay."),
    ("All set, ${memory.name}. Dr. Onyski's office will call (${text}) by 7:30 AM to confirm your appointment.",
     "All set, ${memory.name}. Dr. Zaman's office will call (${text}) by 8:45 AM to confirm your appointment."),
    ("Got it. Dr. Onyski opens new-patient slots Tuesday through Thursday — would tomorrow at 10:30 AM or Wednesday at 2 PM work better for you?",
     "Got it. Dr. Zaman opens new-patient slots Monday through Thursday — would tomorrow at 10:30 AM or Wednesday at 2 PM work better for you?"),
    ("Thanks for sending that over. I've logged your question for Dr. Onyski to review first thing in the morning — she or someone from her team will reach out by 10 AM.",
     "Thanks for sending that over. I've logged your question for Dr. Zaman to review first thing in the morning — he or someone from his team will reach out by 10 AM."),
    ("You're all set, ${memory.name}. Dr. Onyski has been notified, and you'll get a confirmation text from <strong>(407) 732-4570</strong> within the hour.<br><br>Have a good night — and thank you for choosing Wayside.",
     "You're all set, ${memory.name}. Dr. Zaman has been notified, and you'll get a confirmation text from <strong>(407) 846-3662</strong> within the hour.<br><br>Have a good night — and thank you for choosing A Family Dentist."),
    ('<span class="value">Dr. Lyudmila A. Onyski</span>',
     '<span class="value">Dr. Mohammed M. Zaman</span>'),
    ('<span class="value">4907 International Pkwy, Suite 1041</span>',
     '<span class="value">11 W Dakin Ave, Kissimmee</span>'),
    ('<div class="booking-icon">W</div>', '<div class="booking-icon">A</div>'),
    ("Dr. Onyski", "Dr. Zaman"),
    ("Onyski", "Zaman"),
    ("Wayside", "A Family Dentist"),
    ("she'll", "he'll"),
    ("she keeps", "he keeps"),
    ("she calls", "he calls"),
    ("she's", "he's"),
...
# Big John's Rockin' BBQ — John "Big John" Glover, 220 E Monument Ave Kissimmee FL 34741
# (833) 998-8701, downtown lakefront, music-themed décor, ribs/brisket/fried pickles
# Hours: M-W 11-8, Th-Sat 7-9, Sun 8-8. Catering for events.
BIGJOHN_SUBS = [
    ("Pig Floyd's Urban Barbakoa — Reservations & Catering Concierge | Powered by Velo AI",
    ...
    ("Pig Floyd's Concierge", "Big John's Concierge"),
    ('<span class="value">Pig Floyd\'s Team</span>',
...
# West & Kennedy Barbershop — Reggie Jones, master barber, celebrity barber NBA/Grammy
# 543 W New England Ave Ste B, Winter Park FL 32789. (407) 622-6201
# Services: hot towel shave, haircut, hair coloring. M-Th 8-5, Fri 6-5, Sat 6-3.
WESTKENNEDY_SUBS = [
    ("Goldie Salon — Booking & Color Concierge | Powered by Velo AI",
     "West & Kennedy — Booking & Grooming Concierge | Powered by Velo AI"),
    ("This is a live demo built by Velo AI for Goldie Salon.",
    ...
    ('<p class="practice-doctor">Valerie Miller, Owner &amp; Master Stylist</p>',
     '<p class="practice-doctor">Reggie Jones, Owner &amp; Master Barber</p>'),
    ("<strong>Goldie Concierge</strong> · Available 24/7",
     "<strong>West &amp; Kennedy Concierge</strong> · Available 24/7"),
    ("Goldie Concierge", "West & Kennedy Concierge"),
    ('<span class="value">Valerie Miller</span>',
     '<span class="value">Reggie Jones</span>'),
    ("Valerie", "Reggie"),
    ("Goldie", "West & Kennedy"),
]
WESTKENNEDY_CLEANUP = [
...
# Heathrow Dentistry (formerly Lake Mary Family, Cosmetic & Implant Dentistry)
# Dr. Fabrizio Amador, DMD + Dr. Woowon Choi, DMD
# 1511 International Parkway, Lake Mary FL 32746. (407) 333-7393
# General/cosmetic/implant/SimplyClear, M-Th 8-5, Spanish-speaking, Nextdoor Fave 22-24
HEATHROW_SUBS = [
    ("Wayside Family Dental — After-Hours Concierge | Powered by Velo AI",
     "Heathrow Dentistry — After-Hours Concierge | Powered by Velo AI"),
    ("This is a live demo built by Velo AI for Wayside Family Dental.",
     "This is a live demo built by Velo AI for Heathrow Dentistry."),
    ("Sanford, Florida · Est. 2012", "Lake Mary, Florida · Nextdoor Fave 2022 · 2023 · 2024"),
    ('<h1 class="practice-name">Wayside Family Dental</h1>',
     '<h1 class="practice-name">Heathrow Dentistry</h1>'),
    ('<p class="practice-doctor">Dr. Lyudmila A. Onyski, DDS</p>',
     '<p class="practice-doctor">Dr. Fabrizio Amador, DMD &amp; Dr. Woowon Choi, DMD</p>'),
    ("Dr. Onyski is on call to respond to her patients' needs as soon as possible. As a patient of Wayside, you're never alone.",
     "Dr. Amador and Dr. Choi are committed to responding to patient needs as quickly as possible. Same-day emergency appointments are available, and Spanish-speaking care is offered to every patient who needs it."),
    ("4907 International Pkwy, Suite 1041<br>Sanford, FL 32771",
     "1511 International Parkway<br>Lake Mary, FL 32746"),
    ("(407) 732-4570", "(407) 333-7393"),
    ("<strong>Wayside Concierge</strong> · Available 24/7",
     "<strong>Heathrow Concierge</strong> · Available 24/7"),
    ("A patient of Wayside? Dr. Onyski will be notified immediately for urgent matters.",
     "A patient of Heathrow? The on-call doctor will be notified immediately for urgent matters."),
    ("Good evening — you've reached the after-hours line for Wayside Family Dental. Dr. Onyski is unavailable right now, but I can help with most things and reach her directly if it's urgent.",
     "Good evening — you've reached the after-hours line for Heathrow Dentistry. The team is wrapped for the day, but I can help with most things and reach the on-call doctor directly if it's urgent."),
    ("Let me get you to Dr. Onyski as quickly as possible.",
     "Let me get you to the on-call doctor as quickly as possible."),
    ("Understood. I'm flagging this as urgent and texting Dr. Onyski now — she'll call you back within 15 minutes.",
     "Understood. I'm flagging this as urgent and texting the on-call doctor now — they'll call you back within 15 minutes."),
    ("Got it. Dr. Onyski will want to see you first thing — she keeps emergency slots open every morning at 8 AM specifically for situations like this.",
     "Got it. The team will want to see you first thing — they keep same-day emergency slots open specifically for situations like this."),
    ("Great choice to reach out — both implants and Invisalign are major decisions and Dr. Onyski has been doing both since 2010, so you're in capable hands.",
     "Great choice to reach out — both implants and SimplyClear aligners are major decisions, and Heathrow has built a reputation around honest treatment planning. You'll get a clear answer on whether you're a candidate before anyone talks dollars."),
    ("Most patients asking about ${txt} have one of two questions on their mind: <em>\"Am I a candidate?\"</em> and <em>\"What will it actually cost?\"</em><br><br>Both are best answered with a 30-minute consult — Dr. Onyski does a digital scan, reviews your options, and gives you a treatment plan with real numbers before you commit to anything. Wayside also accepts CareCredit if financing helps.",
     "Most patients asking about ${txt} have one of two questions: <em>\"Am I a candidate?\"</em> and <em>\"What will it actually cost?\"</em><br><br>Both are best answered with a consult — digital scan, real options, and a treatment plan with actual numbers before you commit. Heathrow accepts PPO plans, has an in-house discount plan, and offers Sunbit financing if it helps."),
    ("Perfect. Let me hold ${timeMap[value]} for you. What's your first name so I can put it on Dr. Onyski's schedule?",
     "Perfect. Let me hold ${timeMap[value]} for you. What's your first name so I can put it on the schedule?"),
    ("Welcome — Dr. Onyski has been welcoming new patients to Wayside since 2012, and most of our patients come from referrals, so it's nice when someone finds us directly.",
     "Welcome — Heathrow has been a Nextdoor Fave three years running (2022-2024), and most patients come from referrals across Heathrow, Lake Mary, Longwood, and Sanford. It's nice when someone finds us directly."),
    ("Of course — go ahead and type your question and I'll do my best. If it's something Dr. Onyski needs to weigh in on personally, I'll route it to her and she'll get back to you in the morning.",
     "Of course — go ahead and type your question and I'll do my best. If it's something the doctor needs to weigh in on personally, I'll route it and they'll get back to you in the morning."),
    ("Thank you, ${memory.name}. What's the best phone number to reach you at? I want to make sure Dr. Onyski has it before tomorrow morning.",
     "Thank you, ${memory.name}. What's the best phone number to reach you at? I want to make sure the doctor has it before tomorrow morning."),
    ("Thanks, ${memory.name}. What's the best phone number? Dr. Onyski's office will text you a confirmation within an hour of opening.",
     "Thanks, ${memory.name}. What's the best phone number? The Heathrow team will text you a confirmation within an hour of opening."),
    ("Thank you, ${memory.name}. What's the best callback number? Dr. Onyski will call you within 15 minutes.",
     "Thank you, ${memory.name}. What's the best callback number? The on-call doctor will reach you within 15 minutes."),
    ("Perfect. Here's the hold I'm creating for Dr. Onyski:",
     "Perfect. Here's the hold I'm creating for Heathrow:"),
    ("Got it, ${memory.name} — I just paged Dr. Onyski. Expect a call from <strong>(407) 732-4570</strong> within 15 minutes.<br><br>Stay calm, sit upright if possible, and avoid hot or cold liquids until she calls. You're going to be okay.",
     "Got it, ${memory.name} — I just paged the on-call doctor. Expect a call from <strong>(407) 333-7393</strong> within 15 minutes.<br><br>Stay calm, sit upright if possible, and avoid hot or cold liquids until they call. You're going to be okay."),
    ("All set, ${memory.name}. Dr. Onyski's office will call (${text}) by 7:30 AM to confirm your appointment.",
     "All set, ${memory.name}. The Heathrow team will call (${text}) by 8:30 AM to confirm your appointment."),
    ("Got it. Dr. Onyski opens new-patient slots Tuesday through Thursday — would tomorrow at 10:30 AM or Wednesday at 2 PM work better for you?",
     "Got it. Heathrow opens new-patient slots Monday through Thursday — would tomorrow at 10:30 AM or Wednesday at 2 PM work better for you?"),
    ("Thanks for sending that over. I've logged your question for Dr. Onyski to review first thing in the morning — she or someone from her team will reach out by 10 AM.",
     "Thanks for sending that over. I've logged your question for the team to review first thing in the morning — someone will reach out by 10 AM."),
    ("You're all set, ${memory.name}. Dr. Onyski has been notified, and you'll get a confirmation text from <strong>(407) 732-4570</strong> within the hour.<br><br>Have a good night — and thank you for choosing Wayside.",
     "You're all set, ${memory.name}. The Heathrow team has been notified, and you'll get a confirmation text from <strong>(407) 333-7393</strong> within the hour.<br><br>Have a good night — and thank you for choosing Heathrow Dentistry."),
    ('<span class="value">Dr. Lyudmila A. Onyski</span>',
     '<span class="value">Dr. Amador &amp; Dr. Choi</span>'),
    ('<span class="value">4907 International Pkwy, Suite 1041</span>',
     '<span class="value">1511 International Parkway, Lake Mary</span>'),
    ('<div class="booking-icon">W</div>', '<div class="booking-icon">H</div>'),
    ("Dr. Onyski", "the doctor"),
    ("Onyski", "Heathrow"),
    ("Wayside", "Heathrow"),
    ("she'll", "they'll"),
    ("she keeps", "they keep"),
...
JOBS = [
    ...
    # ---- ROUND 6 — Wave 3 net-new ----
    ("zaman", "wayside.html", ZAMAN_SUBS, ZAMAN_CLEANUP),
